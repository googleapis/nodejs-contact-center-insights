...
describe('v1.ContactCenterInsightsClient', () => {
    ...
    describe('updateConversation', () => {
        it('invokes updateConversation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateConversationRequest', ['conversation', 'name']);
    ...
    describe('deleteConversation', () => {
        it('invokes deleteConversation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteConversationRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getAnalysis', () => {
        it('invokes getAnalysis without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetAnalysisRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('deleteAnalysis', () => {
        it('invokes deleteAnalysis without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteAnalysisRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('updateIssueModel', () => {
        it('invokes updateIssueModel without error', async () => {
            ...
            request.issueModel ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateIssueModelRequest', ['issueModel', 'name']);
    ...
    describe('getIssueModel', () => {
        it('invokes getIssueModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetIssueModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.IssueModel()
    ...
    describe('listIssueModels', () => {
        it('invokes listIssueModels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListIssueModelsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getIssue', () => {
        it('invokes getIssue without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetIssueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listIssues', () => {
        it('invokes listIssues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListIssuesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateIssue', () => {
        it('invokes updateIssue without error', async () => {
            ...
            request.issue ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateIssueRequest', ['issue', 'name']);
    ...
    describe('calculateIssueModelStats', () => {
        it('invokes calculateIssueModelStats without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CalculateIssueModelStatsRequest', ['issueModel']);
    ...
    describe('createPhraseMatcher', () => {
        it('invokes createPhraseMatcher without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreatePhraseMatcherRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getPhraseMatcher', () => {
        it('invokes getPhraseMatcher without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetPhraseMatcherRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.contactcenterinsights.v1.PhraseMatcher()
    ...
    describe('deletePhraseMatcher', () => {
        it('invokes deletePhraseMatcher without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeletePhraseMatcherRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('updatePhraseMatcher', () => {
        it('invokes updatePhraseMatcher without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdatePhraseMatcherRequest', ['phraseMatcher', 'name']);
    ...
    describe('calculateStats', () => {
        it('invokes calculateStats without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CalculateStatsRequest', ['location']);
    ...
    describe('updateSettings', () => {
        it('invokes updateSettings without error', async () => {
            ...
            request.settings ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateSettingsRequest', ['settings', 'name']);
    ...
    describe('updateView', () => {
        it('invokes updateView without error', async () => {
            ...
            request.view ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateViewRequest', ['view', 'name']);
    ...
    describe('createAnalysis', () => {
        it('invokes createAnalysis without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateAnalysisRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('exportInsightsData', () => {
        it('invokes exportInsightsData without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ExportInsightsDataRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createIssueModel', () => {
        it('invokes createIssueModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateIssueModelRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteIssueModel', () => {
        it('invokes deleteIssueModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteIssueModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deployIssueModel', () => {
        it('invokes deployIssueModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeployIssueModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('undeployIssueModel', () => {
        it('invokes undeployIssueModel without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UndeployIssueModelRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listAnalyses', () => {
        it('invokes listAnalyses without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListAnalysesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listPhraseMatchers', () => {
        it('invokes listPhraseMatchers without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListPhraseMatchersRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
